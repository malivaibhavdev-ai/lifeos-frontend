...
// same CSS-transition technique as Family's FamilyScoreRing.jsx port.
export function DocumentScoreRing({ score = 0, size = 96, strokeWidth = 8, color = '#7c3aed' }) {
  ...
  return (
    <div style={{ width: size, height: size }} className="relative flex items-center justify-center">
      ...
      <div className="flex flex-col items-center">
        ...
        <span className="text-[10px] font-medium uppercase text-gray-400 dark:text-gray-500">Doc Score</span>
      </div>
    </div>
  );
}
