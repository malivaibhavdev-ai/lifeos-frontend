...
// same CSS-transition technique as Dreams' DreamScoreRing.jsx port.
export function FamilyScoreRing({ score = 0, size = 96, strokeWidth = 8, color = '#0d9488' }) {
  ...
  return (
    <div style={{ width: size, height: size }} className="relative flex items-center justify-center">
      ...
      <div className="flex flex-col items-center">
        ...
        <span className="text-[10px] font-medium uppercase text-gray-400 dark:text-gray-500">Family Score</span>
      </div>
    </div>
  );
}
