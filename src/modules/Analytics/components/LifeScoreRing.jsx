...
// same CSS-transition technique as Documents/Family's own score rings.
export function LifeScoreRing({ score = 0, size = 140, strokeWidth = 12, color = '#7c3aed' }) {
  ...
  return (
    <div style={{ width: size, height: size }} className="relative flex items-center justify-center">
      ...
      <div className="flex flex-col items-center">
        ...
        <span className="text-[11px] font-medium uppercase text-gray-400 dark:text-gray-500">Life Score</span>
      </div>
    </div>
  );
}
